    ...
    <div class="container body">
      <div class="main_container">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li><a href="shoe.php">Toy manager</a></li>
                      ...
                      <li><a href="user.php">User Managemant </a></li>
                    </ul>
                  </li>
                </ul>
              </div>
        ...
        <div class="form-group">
          ...
          <input required minlength="5" maxlength="50" name="name" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter toy name">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Price ($)</label>
          <input required min="0" max="99999999999" name="price" type="number" class="form-control" id="exampleInputPassword1" placeholder="Enter price">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Sale (%)</label>
          <input required min="0" max="100" name="sale" type="number" class="form-control" id="exampleInputPassword1" placeholder="Enter % sale">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Size</label>
          <input required min="1" max="100" name="size" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter size">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Color</label>
          <input required minlength="1" maxlength="50" name="color" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Color">
        </div>
        <div class="form-group">
          <label for="exampleInputPassword1">Review</label>
          <input required minlength="1" maxlength="500" name="review" type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter review">
        </div>
        <div class="form-group">
