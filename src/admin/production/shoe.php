        ...
        <a class="btn btn-primary" href="addShoe.php" role="button">Add toys</a>
          <table id="tableShoe">
            <tr>
              ...
              <th class="text-center" style="min-width:150px">Toy Name</th>
              <th class="text-center" style="min-width:150px">Price</th>
              <th class="text-center" style="min-width:50px"> Discount</th>
              ...
              <th class="text-center" style="min-width:200px">Review</th>
            ...
            <tr>
                ...
                <td><a class="btn btn-danger" href="deleteShoe.php?id=<?php echo $shoe['shoe_id']?>" role="button" onclick="return confirm('You may want to delete?');">Delete</a></td>
            </tr>
            <?php
                  }
            ?>
