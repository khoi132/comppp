    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="form-group">
          ...
          <input required value="<?php echo $userInfo['fullname']?>" minlength="5" maxlength="50" name="fullname" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Full Name">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input required value="<?php echo $userInfo['phone']?>" minlength="0" maxlength="10" name="phone" type="number" class="form-control" id="exampleInputPassword1" placeholder="Phone">
        </div>
        <div class="form-group">
