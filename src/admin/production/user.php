        ...
        <div class="right_col" role="main">
          <table id="tableShoe">
            <tr>
              ...
              <th class="text-center" style="min-width:150px">Birthday</th>
            ...
            <tr>
                ...
                <td><a class="btn btn-warning" href="updateUser.php?id=<?php echo $user['id']?>" role="button">Update</a></td>
                <td><a class="btn btn-danger" href="deleteUser.php?id=<?php echo $user['id']?>" role="button" onclick="return confirm('You may want to delete?');">Delete</a></td>
            </tr>
            <?php
                  }
            ?>
